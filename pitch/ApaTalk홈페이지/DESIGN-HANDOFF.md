# a9f45198-805d-4aa0-9280-0c3e26f08b72 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `apatalk-landing-prompt.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `apatalk-landing-prompt.html`
...
- A single self-contained `apatalk-landing-prompt.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `apatalk-landing-prompt.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `apatalk-landing-prompt.html`
- `apatalk-project-deck.html`
- `apatalk-prototype-phone.html`
- `apatalk-toss-landing-sage.html`
- `apatalk-toss-landing.html`
- `gemini-code-1786614531177.html`
...
- `1.-1.pptx`
- `1..pptx`
- `apatalk-landing-prompt.md`
- `brand-spec.md`
- `image.png`

## Coding checklist for AI tools
1. Inspect `apatalk-landing-prompt.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
